package com.flzc.message.jpush.connection;
...
public class NativeHttpClient implements IHttpClient {
    ...
    public ResponseWrapper doRequest(String url, String content, RequestMethod method) throws Exception {
    ...
    private ResponseWrapper _doRequest(String url, String content, RequestMethod method) throws Exception, 
